@ECHO OFF
TITLE CrimeAndEnprisonmentSimulator
...
CD CrimeAndEnprisonmentSimulator

REM Start the Model
START javaw -Xss10M -Xmx400M -cp %CP% repast.simphony.runtime.RepastMain ./CrimeAndEnprisonmentSimulator.rs
